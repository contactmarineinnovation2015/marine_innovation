    ...
    return (
        <Container sx={{py: 4}} ref={ref}>
            ...
            <CardActions sx={{ justifyContent: "center" }}>
                <Button onClick={() =>  setLocation('/partners')} variant="contained" style={{backgroundColor: '#456882', borderWidth: 3, fontWeight: 'bold', marginTop: '6rem'}}>{`View More Partners >`}</Button>
            </CardActions>
        </Container>
    );
}
